...
class ParrotTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::EUROPEAN, 1, 0, false);
        $this->assertEquals(12.0, $parrot->getSpeed());
    }
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::EUROPEAN, 0, 1, false);
        $this->assertEquals(12.0, $parrot->getSpeed());
    }
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::EUROPEAN, 0, 0, true);
        $this->assertEquals(12.0, $parrot->getSpeed());
    }
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::AFRICAN, 0, 1, false);
        $this->assertEquals(12.0, $parrot->getSpeed());
    }
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::AFRICAN, 0, 0, true);
        $this->assertEquals(12.0, $parrot->getSpeed());
    }
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE, 0, 1, false);
        $this->assertEquals(12.0, $parrot->getSpeed());
    }
    ...
    {
        $parrot = new Parrot(ParrotTypeEnum::NORWEGIAN_BLUE, 1, 1, false);
        $this->assertEquals(12.0, $parrot->getSpeed());
    }
}
